...
gta.MainMenu.prototype = {
	create: function(){
		// display images
		var a = this.add.sprite(0, 0, 'mainMenuSprites', null);
		a.frameName = "frontPage.png";
		...
		this.add.button(gta.GAME_WIDTH/2, gta.GAME_HEIGHT/2 , 'button-start', this.startGame, this, 1, 0, 1, 0); 
        ...
        var fontStyle = { font: "20px RockText", fill: "#FFCC00", stroke: "#333", strokeThickness: 5, align: "right" },
        ...
        // highScoreObj.text = this.add.bitmapText(gta.GAME_WIDTH, gta.GAME_HEIGHT - 110, "rock", "HighScore" , 30);
